...
//------------------------------------------------------------------------------//
        ...
        {
            //argument = Encipher(argument, "kukucs");

            var ant = (IMyRadioAntenna)GridTerminalSystem.GetBlockWithName("Antenna");            
            ant.TransmitMessage(argument, MyTransmitTarget.Default);
