...
//------------------------------------------------------------------------------//
        ...
        {
            //argument = Decipher(argument, "kukucs");

            var LCDDebug = (IMyTextPanel)GridTerminalSystem.GetBlockWithName("LCDDebug");
            LCDDebug.WritePublicText(argument);
            LCDDebug.ShowPublicTextOnScreen();

            if (argument == "OpenHangar")
            {
                OpenHangar("Hangar Left Door");
                OpenHangar("Hangar Right Door");

            } else if (argument == "CloseHangar")
            {
                CloseHangar("Hangar Left Door");
                CloseHangar("Hangar Right Door");
            }
            
        }


        public void OpenHangar(string HangarGroup)
        {
            var hangarGroup = GridTerminalSystem.GetBlockGroupWithName(HangarGroup);
        ...
        public void CloseHangar(string HangarGroup)
        {
            var hangarGroup = GridTerminalSystem.GetBlockGroupWithName(HangarGroup);
            List<IMyAirtightHangarDoor> doors = new List<IMyAirtightHangarDoor>();
            hangarGroup.GetBlocksOfType(doors);
